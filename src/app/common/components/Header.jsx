...
const Header = ({ pages }) => {
  ...
  return (
    <div className="app__header">
      ...
      {pages.map(page => (
        <NavLink key={page.path} to={page.path} className="app__header-item" activeClassName="app__header-item--active">
          {page.name}
        </NavLink>
      ))}
      <div className="app__header-select">
        <select value={isLanguageExist ? locale : 'en'} onChange={e => changeLang(e.target.value, dispatch)}>
